      ...
      <div>
        <Container className="email-container">
          <div className="text-center">
            ...
            <p>Enter the email connected to your account below and <br/>click send to recieve a password recovery email</p>
          </div>
            ...
            <Row>
              <Col>
                <Form>
                  ...
                  <Button className="send-button" variant="primary" onClick={doRequestPasswordReset}>Send <Envelope/></Button>
                </Form>
              </Col>
            </Row>
          </Container>
        </Container>
        <Button className="go-back-button" variant="primary" onClick={handleGoBack}>Go back <ChevronRight/></Button>
      </div>
    );
}